...
class userplan2
	...
	function view_plan($db_object,$common,$default,$user_id,$uid,$gblfreq,$gblpercent,$s_id,$post_var)
		{
			...
			$filename = $path."/templates/performance/userplan2_input_static.html";
	...
	if($back!="")
	{
		header("location: userplan1_input_static.php?uid=$emp_id");
	}	
	if($next!="")
	{
		header("location: userplan3_input_static.php?uid=$emp_id");
	}
