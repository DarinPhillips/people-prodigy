...
class header
{
  function  header_display($common,$db_object,$user_id,$error_msg,$default,$gbl_files)
  {

	$path = $common->path;
	$filename="$path"."/templates/performance/header.html";
...
$hdobj=new header;
$hdobj->header_display($common,$db_object,$user_id,$error_msg,$default,$gbl_files);
$common->lang_menu($db_object,$default,$form);
?>
