...
class search
{
	function show_form($db_object,$common,$user_id,$default)
	{
		...
		$xtemplate=$path."templates/career/search_reports_skill.html";
	...
	function search_reports($db_object,$common,$user_id,$_POST,$error_msg)
	{
				
		$fSkill_id_t=$_POST[fSkill_id_t];
		
		$fSkill_id_i=$_POST[fSkill_id_i];
		
		$fComp_id_t=$_POST[fComp_id_t];
		
		$fComp_id_i=$_POST[fComp_id_i];
		...
		$user_below=@array_merge($users,$users_under_id);
		...
		$xtemplate=$xpath."templates/career/search_by_skill_result.html";
