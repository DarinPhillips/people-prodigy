...
class View_Demo
{
	function view_employees($common,$db_object,$default)
	{
		$path=$common->path;
		$xFile=$path."templates/core/view_demographics.html";
...
function search_for_data($common,$db_object,$default,$error_msg,$form_array)
	{
...
$path=$common->path;
$xFile=$path."templates/core/view_demographic_employee.html";
$xTemplate=$common->return_file_content($db_object,$xFile);
...
if($fSubmit)
{
	$demobj->search_for_data($common,$db_object,$default,$error_msg,$post_var);
	exit;
}


$demobj->view_employees($common,$db_object,$default);
include("footer.php");
