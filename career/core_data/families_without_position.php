...
$selqry="select $family_table.family_id,$family_table.family_name,$family_table.date_added,$family_table.added_by from $family_table left join $family_position on $family_table.family_id=$family_position.family_id where $family_position.family_id is null";
