...
{
function show_screen($db_object,$common,$post_var,$default,$user_id,$error_msg)
	{
	$xPath=$common->path;
	$returncontent=$xPath."/templates/career/emp_without_iskill.html";
...
//DISPLAYING THE USERS WITHOUT EVEN ONE INTERPERSONAL SKILL WITH THEM (HAVENT' RATED YET)
...
$obj->show_screen($db_object,$common,$post_var,$default,$user_id,$error_msg);
