...
class fit
{
	function onelevel_up_fit($db_object,$common,$image,$user_id)
	{
		...
		$sql="select onelevel_up from $career_goals where user_id='$user_id' and interest='lot'";
...
$obj->onelevel_up_fit($db_object,$common,$image,$user_id);
