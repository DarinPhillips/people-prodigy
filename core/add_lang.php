...
function show_add($db_object,$common,$error_msg)
{
	...
	$out = join("",$file);
	$out  = $common->direct_replace($db_object,$out,$val);
	echo $out;
...
approved_subject_$lang_id text,approved_message_$lang_id text,resubmit_subject_$lang_id text,resubmit_message_$lang_id text,reject_subject_$lang_id text,
reject_message_$lang_id text,obj_message_$lang_id text,obj_subject_$lang_id text,obj_app_subject_$lang_id text,
obj_app_message_$lang_id text,verification_submit_sub_$lang_id text,verification_submit_message_$lang_id text,
verification_rej_sub_$lang_id text,verification_rej_message_$lang_id text,verification_remind_sub_$lang_id text,
verification_remind_message_$lang_id text,app_feedback_subject_$lang_id text,add_feedback_message_$lang_id text)";
$db_object->insert($qry);
...
$qry = "alter table $langsetting add column (requesttext_$lang_id text,approvaltext_$lang_id text)";
$db_object->insert($qry);

$langresult = $common->prefix_table("learning_result");
$qry = "alter table $langresult add column result_$lang_id text";
$db_object->insert($qry);
