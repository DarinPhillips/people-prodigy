...
//$selqry="select $user_table.user_id,$user_table.username,$user_table.position,date_format($user_table.reg_date,'%m.%d.%Y.%i:%s') as reg_date from  $user_table left join $position_table on  $position_table.pos_id=$user_table.position where $user_table.position is null and $user_table.user_type<>'external'";
...
date_format($position_table.date_added,'%m.%d.%Y.%i:%s') as date_added 
,$position_table.added_by,$user_table.position from $position_table left join $user_table on $position_table.pos_id=$user_table.position where $user_table.position is null";
