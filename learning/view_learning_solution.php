...
class view
{
	...
	function show_skill_links($db_object,$common,$default,$fEmployee_id,$error_msg)
	{
		...
		$xTemplate=$path."/templates/learning/view_learning_solution_links.html";
		...
		$pos_qry="select position from $user_table where user_id='$fEmployee_id'";
		...
		and skill_id <>'0' group by skill_id";		
	...
	function view_solution($db_object,$common,$default,$skill_id,$error_msg,$user_id)
	{
	...
	$xFile=$path."/templates/learning/view_learning_solution.html";
...
{
case NULL:
	$obj->show_skill_links($db_object,$common,$default,$user_id,$error_msg);
...
case "show":
	...
	$obj->view_solution($db_object,$common,$default,$skill_id,$error_msg,$fUser);
